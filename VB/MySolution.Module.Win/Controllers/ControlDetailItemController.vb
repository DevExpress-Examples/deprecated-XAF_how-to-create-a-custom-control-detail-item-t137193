...
Namespace MySolution.Module.Win.Controllers
	Public Class ControlDetailItemController
		...
		Private Sub item_ControlCreated(ByVal sender As Object, ByVal e As EventArgs)
			TryCast((CType(sender, ControlDetailItem)).Control, Button).Text = "Click me!"
			AddHandler TryCast((CType(sender, ControlDetailItem)).Control, Button).Click, AddressOf ButtonClickHandlingWinController_Click
		End Sub
